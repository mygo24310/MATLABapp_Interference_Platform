classdef ganshe1_exported < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.ExperimentalparametersettingPanel.Tooltip = {'The input value must be a positive number'};
